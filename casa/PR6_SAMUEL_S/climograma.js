...
function finiciar() {
    ...
    for (let i = 0; i < meses.length; i++) {
        do {
            precipitacion = window.prompt("Intoduce precipitacion para " + meses[i]);
    ...
    document.getElementById('precipitacion').innerHTML = pintar(precipitaciones, meses, "PRECIPITACIONES");
